...
_extension = Extension('_libdecimate',
                   ['libdecimate.i','matalloc.c','libdecimate.c'],
...
setup(
    ...
    description           = 'Find unique RGB triplets (1d, 2d, 3d)',
    long_description      = read('../README.md'),
    url                   = 'https://github.com/zindy/manc_suplemental',
    keywords              = 'python imaging microscopy',
    author                = 'Egor Zindy',
